...
pecan_standard_met_table <- tibble::tribble(
  ...
  "mole_fraction_of_carbon_dioxide_in_air"                , "mol/mol"     ,        FALSE,  NA                  , NA             , NA       , NA      , "CO2"              , NA    ,
  ...
  "wind_speed"                                            , "m/s"         ,        FALSE,  "Wspd"              , NA             , NA       , NA      , "WS"               , NA    ,
  "eastward_wind"                                         , "m/s"         ,         TRUE,  "eastward_wind"     , NA             , NA       , NA      , "CALC(WS+WD)"      , "u10" ,
  "northward_wind"                                        , "m/s"         ,         TRUE,  "northward_wind"    , NA             , NA       , NA      , "CALC(WS+WD)"      , "v10"
)
